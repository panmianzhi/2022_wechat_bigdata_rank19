...
def build_optimizer_raw(args, model, lr):
    # Prepare optimizer and schedule (linear warmup and decay)
    no_decay = ['bias', 'LayerNorm.weight']
    optimizer_grouped_parameters = [
        {'params': [p for n, p in model.named_parameters() if not any(nd in n for nd in no_decay)],
...
#     no_decay = ['bias', 'LayerNorm.weight']
#     optimizer_grouped_parameters = [
#         {'params': [p for n, p in model.named_parameters() if not any(nd in n for nd in no_decay) and 'clip' in n],'weight_decay': args.weight_decay,'lr':args.clip_learning_rate},
#         {'params': [p for n, p in model.named_parameters() if any(nd in n for nd in no_decay) and 'clip' in n], 'weight_decay': 0.0,'lr':args.clip_learning_rate},
#         {'params': [p for n, p in model.named_parameters() if not any(nd in n for nd in no_decay) and 'clip' not in n],'weight_decay': args.weight_decay,'lr':args.learning_rate},
#         {'params': [p for n, p in model.named_parameters() if any(nd in n for nd in no_decay) and 'clip' not in n], 'weight_decay': 0.0,'lr':args.learning_rate}
#     ]
